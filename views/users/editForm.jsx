    ...
    return (
      <Default cookie={this.props.cookie}>
        <div className="row mb-3">
          <div className="col">
            <h4 className="neon-green border-bottom-neon m-l-xtra">
              EDIT PROFILE
            </h4>
          </div>
        </div>
        <div className="row">
          <div className="col-12 col-md-6 mb-3 img-container m-l-xtra">
            <img id="initial-pic" src={image} width="320px" height="300px" />
          </div>
            ...
            >
              ...
              <div className="form-row mt-3">
                <div className="form-group col-8">
                  ...
                  <input
                    className="bg-dark form-control neon-green"
                    type="text"
                    name="username"
                ...
                <div className="form-group col-4">
                  ...
                  <input
                    className="bg-dark neon-green form-control longText"
                    type="number"
                    name="age"
